...
import ai.polyakov.restaurantvoiting.to.UserTo;
import ai.polyakov.restaurantvoiting.util.JsonUtil;
import ai.polyakov.restaurantvoiting.util.UsersUtil;

import static org.hamcrest.Matchers.containsString;
import static org.springframework.test.web.servlet.result.MockMvcResultHandlers.print;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.content;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.status;
import static ai.polyakov.restaurantvoiting.web.user.ProfileController.REST_URL;
...
class ProfileControllerTest extends AbstractControllerTest {
    ...
    void delete() throws Exception {
        ...
        UserTestData.USER_MATCHER.assertMatch(repository.findAll(), UserTestData.admin);
    }
